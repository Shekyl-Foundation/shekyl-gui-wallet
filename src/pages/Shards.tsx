...
import ShardCard from "../components/shards/ShardCard";
...
/**
 * Operator gallery: profit-ordered coverage from the local daemon, with
 * click-to-toggle selection stored in GUI session state. The page never
 * fetches shard bodies; PNGs are requested per card, lazily.
 */
